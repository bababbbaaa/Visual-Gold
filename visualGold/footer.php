                ...
                <div class="container">
                    <div class="main-footer__menu">
                        ...
                        <div class="main-footer__menu--address address-footer">
                            ...
                            <p class="address-footer__text"><?php the_field('address'); ?></p>
                            <a class="address-footer__link link" href="mailto:<?php the_field('email'); ?>">e-mail:
                            <?php the_field('email'); ?></a>
                            <a class="address-footer__link link" href="skype:<?php the_field('skype'); ?>">skype: <?php the_field('skype'); ?></a>
                            <span class="nav-footer__border"></span>
                        </div>
                        <div class="main-footer__menu--delivery delivery-footer">
                            ...
                            <ul class="delivery-footer__list list">
                                <li class="delivery-footer__item">
                                    <a class="delivery-footer__item-link link" href="<?php the_field('delivery-post'); ?>">почтовая доставка,</a>
                                </li>
                                <li class="delivery-footer__item">
                                    <a class="delivery-footer__item-link link" href="<?php the_field('delivery-transport'); ?>">транспортные компании,</a>
                                </li>
                                <li class="delivery-footer__item">
                                    <a class="delivery-footer__item-link link" href="<?php the_field('delivery'); ?>">сервисы доставки</a>
                                </li>
                            </ul>
                            <span class="nav-footer__border"></span>
                        </div>
                        <div class="main-footer__menu--contact contact-footer">
                            ...
                            <div class="contact-footer__phones">
                                <a class="contact-footer__phone link" href="tel:<?php the_field('phone-number'); ?>" target="_blank"><?php the_field('phone'); ?></a>
                                <a class="contact-footer__phone link" href="tel:<?php the_field('phone-additionally-number'); ?>" target="_blank"><?php the_field('phone-additionally'); ?></a>
                        ...
                        <div class="main-footer__menu--subscription subscription-footer">
                            ...
                            <form class="subscription-footer__form" action="#">
                                <?php echo do_shortcode('[contact-form-7 id="49" title="Форма подписки"]'); ?>
                            </form>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="supinfo__wrapper--info">
                                ...
                                <ul class="supinfo__wrapper--info-list list">
                                    ...
                                    <li class="supinfo__wrapper--info-item"> <a
                                            class="supinfo-data__social-instagram link instagram" href="<?php the_field('link-instagram'); ?>"
                                            target="_blank">
